...
The employee can also click on the ‚ÄúForgot Password‚Äù link to go to the 
...
click on the moreù link to go to the full announcement page.
...
The employee can click on the Change Addr/Phone
ù button to also go to the 
...
on View Previous Pay Stubùto then go to the View Previous Pay Stub page.
...
On the Home page My Profileù button:
If the employee clicks on the My Profileùbutton on the home page, the employee 
...
cancel or click on the Homeù button to go back to the Home page or to click on the 
...
2) Add more background (images, color scheme).  Possibly display ‚Äúpellet‚Äù image.
